...
- **Wide Shot and Overcharge already bind to the same long-press input with
  ...
  drafted width at flat cost); Overcharge (#12) reads the same hold as
  ...
  while auditing Overcharge's overlap with other reach-extending abilities
  (see Overrun, #27, and its note on why Contested Ground's chaining was
  folded into Overcharge+Breach instead of staying a separate stack
  ...
  (Overcharge/Wide Shot's landing session, §7).
