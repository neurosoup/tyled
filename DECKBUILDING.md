...
Overpen/CG rule) and "a later-appended entry is a fallback" (Lance) coexist
...
`{Overpen, Lance}`), measured via layers 2 and 4, never smuggled onto the A
